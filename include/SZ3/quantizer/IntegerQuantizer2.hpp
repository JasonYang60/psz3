...
namespace SZ3 {
    ...
    public:
        LinearQuantizer2(size_t num_) : num(num_), error_bound(1), error_bound_reciprocal(1), radius(178956970) {} //radius(32768)

        LinearQuantizer2(size_t num_, T eb, int r = 178956970) : num(num_), error_bound(eb), //int r = 32768
